...
<?php $__env->startSection('content'); ?>
    ...
    <div class="row">
        <div class="col-md-2">
            <a href="<?php echo e(route('mapel.create')); ?>" class="btn btn-primary">Tambah Mapel</a><br><br>
        </div>
            ...
            <form action="#" class="flex-sm">
                <div class="input-group">
                    ...
                    <div class="input-group-append">
                        ...
                        <button onclick="window.location.href='<?php echo e(route('mapel.index')); ?>'" type="button"
                ...
                <?php $__empty_1 = true; $__currentLoopData = $mapels; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mapel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr>
                        ...
                        <td align="center">
                            ...
                            <a href="<?php echo e(route('mapel.edit', $mapel)); ?>" type="button" class="btn btn-sm btn-info"><i
                                    class="fas fa-pen"></i></a>
                            <a href="javascript:void(0)" id="btn-delete" class="btn btn-sm btn-danger"
                                onclick="deleteData('<?php echo e($mapel->id_mapel); ?>')" data-toggle="modal"
...
<?php $__env->startSection('script'); ?>
    <script>
        function deleteData(id) {
            let url = '<?php echo e(route('mapel.destroy', ':id')); ?>';
...
<?php echo $__env->make('layouts.home', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\Zidan\Akprind\Sistem-Informasi-Pembayaran-PPLQ\resources\views/mata-pelajaran/index.blade.php ENDPATH**/ ?>