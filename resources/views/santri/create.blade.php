        ...
        <div class="row">
            <div class="col-sm">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('nama_santri') is-invalid @enderror" name="nama_santri" value="{{ old('nama_santri') }}">
                    @error('nama_santri')
        ...
        <div class="col-sm">
            ...
            <div class="col-sm">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('golongan_darah') is-invalid @enderror" name="golongan_darah" value="{{ old('golongan_darah') }}">
        ...
        <div class="row">
            <div class="col-sm">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('pendidikan_formal') is-invalid @enderror" name="pendidikan_formal" value="{{ old('pendidikan_formal') }}">
            ...
            <div class="col-sm">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('pendidikan_non_formal') is-invalid @enderror" name="pendidikan_non_formal" value="{{ old('pendidikan_non_formal') }}">
        ...
        <div class="row">
            ...
            <div class="col-sm">
                <div class="form-group">
                    ...
                    <input type="file" class="form-control-file @error('foto_kk') is-invalid @enderror" name="foto_kk" value="{{ old('foto_kk') }}">
                    <span class="text-small text-danger font-italic">File extension only: jpg, jpeg, png | Max Upload Image is 2048 Kb</span>
                    @error('foto_kk')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control @error('kategori_santri_id') is-invalid @enderror" name="kategori_santri_id">
                        ...
                        @foreach ($kategori_santris as $kategori )
                            <<option value="{{ $kategori->id_kategori_santri }}" {{ old('user_id') == $kategori->id_kategori_santri ? 'selected' : '' }}>
        ...
        <div class="row">
            ...
            <div class="col-sm">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('no_hp_ayah') is-invalid @enderror" name="no_hp_ayah" value="{{ old('no_hp_ayah') }}">
                    @error('no_hp_ayah')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
        ...
        <div class="row">
            ...
            <div class="col-sm">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('tempat_lahir_ayah') is-invalid @enderror" name="tempat_lahir_ayah" value="{{ old('tempat_lahir_ayah') }}">
            ...
            <div class="col-sm">
                <div class="form-group">
                    ...
                    <input type="date" class="form-control @error('tanggal_lahir_ayah') is-invalid @enderror" name="tanggal_lahir_ayah" value="{{ old('tanggal_lahir_ayah') }}">
        ...
        <div class="row">
            ...
            <div class="col-sm">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('no_hp_ibu') is-invalid @enderror" name="no_hp_ibu" value="{{ old('no_hp_ibu') }}">
                    @error('no_hp_ibu')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
        ...
        <div class="row">
            ...
            <div class="col-sm">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('tempat_lahir_ibu') is-invalid @enderror" name="tempat_lahir_ibu" value="{{ old('tempat_lahir_ibu') }}">
            ...
            <div class="col-sm">
                <div class="form-group">
                    ...
                    <input type="date" class="form-control @error('tanggal_lahir_ibu') is-invalid @enderror" name="tanggal_lahir_ibu" value="{{ old('tanggal_lahir_ibu') }}">
        ...
        <div class="row">
            ...
            <div class="col-sm">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('no_hp_wali') is-invalid @enderror" name="no_hp_wali" value="{{ old('no_hp_wali') }}">
                    @error('no_hp_wali')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
        ...
        <div class="row">
            ...
            <div class="col-sm">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('tempat_lahir_wali') is-invalid @enderror" name="tempat_lahir_wali" value="{{ old('tempat_lahir_wali') }}">
            ...
            <div class="col-sm">
                <div class="form-group">
                    ...
                    <input type="date" class="form-control @error('tanggal_lahir_wali') is-invalid @enderror" name="tanggal_lahir_wali" value="{{ old('tanggal_lahir_wali') }}">
