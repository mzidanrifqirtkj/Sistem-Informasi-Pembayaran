            ...
            <form action="#" class="flex-sm">
                <div class="input-group">
                    ...
                    <div class="input-group-append">
                        ...
                        <button onclick="window.location.href='{{ route('santri.tagihan_bulanan.index') }}'" type="button"
        ...
        <table class="table table-hover table-bordered">
            ...
            <tbody>
                @forelse ($santris as $santri)
                    <tr align="center">
                        <td><a href="{{ route('santri.santri.show', $santri) }}"
                ...
                <form action="#" class="flex-sm">
                    <div class="input-group">
                        ...
                        <div class="input-group-append">
                            <button class="btn btn-primary mr-2 rounded-right" type="submit"><i
                                    class="fas fa-search"></i></button>
                            <button onclick="window.location.href='{{ route('santri.tagihan_bulanan.index') }}'"
                ...
                <tbody>
                    @forelse ($dataTagihans as $result)
                        <tr>
                            ...
                            <td><a href="{{ route('santri.santri.show', $result->santri) }}"
