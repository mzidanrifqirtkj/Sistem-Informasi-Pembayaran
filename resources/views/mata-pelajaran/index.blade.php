...
@section('content')
    ...
    <div class="row">
        <div class="col-md-2">
            <a href="{{ route('mapel.create') }}" class="btn btn-primary">Tambah Mapel</a><br><br>
        </div>
            ...
            <form action="#" class="flex-sm">
                <div class="input-group">
                    ...
                    <div class="input-group-append">
                        ...
                        <button onclick="window.location.href='{{ route('mapel.index') }}'" type="button"
            ...
            <tbody>
                @forelse ($mapels as $mapel)
                    <tr>
                        ...
                        @else --}}
                            {{-- <a href="{{ route('mapel.edit', $mapel) }}" type="button" class="btn btn-sm btn-info"><i class="fas fa-pen"></i></a> --}}

                            <a href="{{ route('mapel.edit', $mapel) }}" type="button" class="btn btn-sm btn-info"><i
...
@section('script')
    <script>
        function deleteData(id) {
            let url = '{{ route('mapel.destroy', ':id') }}';
