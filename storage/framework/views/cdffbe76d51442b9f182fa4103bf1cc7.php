        ...
        <div class="row">
            ...
            <div class="col-sm-8">
                <div class="form-group">
                    ...
                    <h4><?php echo e($santri->user->email); ?></h4>
                </div>
            </div>
        </div>
        <div class="row">
...
<?php echo $__env->make('layouts.home', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\SIAKAD_LQ\resources\views/santri/show.blade.php ENDPATH**/ ?>