...
<head>
    ...
    <title><?php echo $__env->yieldContent('title_page', 'Al-luqmaniyyah'); ?></title>
    <!-- Favicon -->
    <link rel="favicon icon" href="<?php echo e(asset('assets/img/logo.ico')); ?>" type="image/x-icon">
...
<?php /**PATH C:\laragon\www\Zidan\Akprind\Sistem-Informasi-Pembayaran-PPLQ\resources\views/layouts/guest.blade.php ENDPATH**/ ?>