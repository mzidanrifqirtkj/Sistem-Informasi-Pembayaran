...
@section('content')
    ...
    <form action="{{ route('biaya_terjadwal.update', $data->id_biaya_terjadwal) }}" method="post">
        @csrf
        @method('PUT')
        <div class="container">
            <div class="row">
                <div class="col-sm">
                    <div class="form-group">
                        ...
                        <input id="nama_biaya" type="text" class="form-control @error('nama_biaya') is-invalid @enderror"
                            name="nama_biaya" value="{{ old('nama_biaya', $data->nama_biaya) }}" required
                            autocomplete="nama_biaya">
                ...
                <div class="col-sm">
                    <div class="form-group">
                        ...
                        <input id="nominal" type="number" class="form-control @error('nominal') is-invalid @enderror"
                            name="nominal" value="{{ old('nominal', $data->nominal) }}" required autocomplete="nominal"
                            min=0>
                ...
                <div class="col-sm">
                    <div class="form-group">
                        ...
                        <select class="form-control @error('periode') is-invalid @enderror" name="periode">
                            <option value="tahunan" {{ old('periode', $data->periode) == 'tahunan' ? 'selected' : '' }}>
                                Tahunan</option>
                            <option value="sekali" {{ old('periode', $data->periode) == 'sekali' ? 'selected' : '' }}>Sekali
                            </option>
                        </select>
                        @error('periode')
                            <span class="invalid-feedback" role="alert">
