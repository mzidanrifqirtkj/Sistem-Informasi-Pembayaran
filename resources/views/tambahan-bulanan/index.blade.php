...
<div class="row">
    <div class="col-md-2 mb-3">
        ...
        <a href="{{ route('admin.tambahan_bulanan.create') }}" class="btn btn-primary">Tambah Item</a><br><br>
        {{-- @endif --}}
    </div>
</div>
<div class="row g-4">
        ...
        <div class="card shadow-sm">
            ...
            <div class="card-body text-center">
                ...
                <div class="d-flex justify-content-center gap-2">
                    <a href="{{ route('admin.tambahan_bulanan.edit', $item->id_tambahan_bulanan) }}" class="btn btn-sm btn-info">
                        <i class="fas fa-pen"></i> Edit
                    </a>
                    <button class="btn btn-sm btn-danger" onclick="deleteItem('{{ $item->id_tambahan_bulanan }}')" data-toggle="modal" data-target="#deleteSantriModal">
...
<script>
    ...
    function deleteItem(id) {
        let url = '{{ route("admin.tambahan_bulanan.destroy", ":id") }}';
