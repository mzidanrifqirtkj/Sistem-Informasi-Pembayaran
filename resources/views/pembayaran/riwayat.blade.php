...
<div class="row">
    <div class="col-md-4">
        <a href="{{ route('admin.pembayaran.index') }}" class="btn btn-primary">Bayar Tagihan</a><br><br>
    </div>
                ...
                <td>
                    <div class="custom-control custom-checkbox" style="display: flex">
                        <input type="checkbox" class="custom-control-input" id="cbx-{{ $loop->index }}" disabled
                            @if (in_array($month, $bulanTagihanLunas)) checked @endif>
        ...
        <table class="table table-hover table-bordered">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><a href="{{ route('admin.santri.show', $result->tagihanBulanan->santri ?? $result->tagihanTerjadwal->santri) }}" target="blank">{{ $result->tagihanBulanan->santri->nama_santri ?? $result->tagihanTerjadwal->santri->nama_santri}}</a></td>
                    ...
                    {{-- <td>{{ $result->date }}</td> --}}
                    <td align="center">
                        {{-- <a href="{{ route('admin.pembayaran.edit', $result->id_tagihan_bulanan) }}" type="button" class="btn btn-sm btn-warning"><i class="fas fa-print"></i></a> --}}
