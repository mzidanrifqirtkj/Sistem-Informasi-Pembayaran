...
<?php $__env->startSection('content'); ?>
    ...
    <div class="row">
        <div class="col-md-2">
            <a href="<?php echo e(route('kelas.create')); ?>" class="btn btn-primary">Tambah Kelas</a><br><br>
        </div>
            ...
            <form action="#" class="flex-sm">
                <div class="input-group">
                    ...
                    <div class="input-group-append">
                        ...
                        <button onclick="window.location.href='<?php echo e(route('kelas.index')); ?>'" type="button"
            ...
            <tbody>
                <?php $__empty_1 = true; $__currentLoopData = $kelas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kls): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr>
                        ...
                        <td><?php echo e($kls->nama_kelas); ?></td>
                        <td align="center">
                            
                            <a href="<?php echo e(route('kelas.edit', $kls)); ?>" type="button" class="btn btn-sm btn-info"><i
                                    class="fas fa-pen"></i></a>
                            <a href="javascript:void(0)" id="btn-delete" class="btn btn-sm btn-danger"
                                onclick="deleteData('<?php echo e($kls->id_kelas); ?>')" data-toggle="modal"
...
<?php $__env->startSection('script'); ?>
    <script>
        function deleteData(id) {
            let url = '<?php echo e(route('kelas.destroy', ':id')); ?>';
...
<?php echo $__env->make('layouts.home', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\Zidan\Akprind\Sistem-Informasi-Pembayaran-PPLQ\resources\views/kelas/index.blade.php ENDPATH**/ ?>