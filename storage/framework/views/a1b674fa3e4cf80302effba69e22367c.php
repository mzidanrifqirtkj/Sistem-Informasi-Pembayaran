                        ...
                        <td>
                            ...
                            <form action="<?php echo e(route('qori_kelas.toggle-status', $qori->id_qori_kelas)); ?>" method="POST"
                                ...
                                <input type="hidden" name="status"
                                    value="<?php echo e($qori->status === 'aktif' ? 'non_aktif' : 'aktif'); ?>">
                                <button type="submit"
...
<?php echo $__env->make('layouts.home', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\Zidan\Akprind\Sistem-Informasi-Pembayaran-PPLQ\resources\views/qori_kelas/index.blade.php ENDPATH**/ ?>