...
@section('content')
    ...
    <div class="row">
        <div class="col-md-2">
            <a href="{{ route('ustadz.add') }}" class="btn btn-primary">Tambah Ustadz</a><br><br>
        </div>
            ...
            <form action="#" class="flex-sm">
                <div class="input-group">
                    ...
                    <div class="input-group-append">
                        ...
                        <button onclick="window.location.href='{{ route('santri.index') }}'" type="button"
            ...
            <tbody>
                @forelse ($ustadzs as $ustadz)
                    <tr>
                        ...
                        @else --}}
                            <a href="{{ route('santri.edit', $ustadz) }}" type="button" class="btn btn-sm btn-info"><i
                                    class="fas fa-pen"></i></a>
                            <a href="javascript:void(0)" id="btn-delete" class="btn btn-sm btn-danger"
                                onclick="deleteData('{{ $ustadz->id_kelas }}')" data-toggle="modal"
