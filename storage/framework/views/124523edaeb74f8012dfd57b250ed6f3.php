                ...
                <?php $__empty_1 = true; $__currentLoopData = $mapelKelas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mapel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr>
                        ...
                        <td align="center">
                            ...
                            <a href="<?php echo e(route('mapel_kelas.edit', $mapel)); ?>" type="button" class="btn btn-sm btn-info"><i
...
<?php echo $__env->make('layouts.home', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\SIAKAD_LQ\resources\views/mapel-kelas/index.blade.php ENDPATH**/ ?>