        ...
        <div class="row">
            <div class="col-sm">
                <div class="form-group">
                    ...
                    <input id="tahun_ajar" type="tahun_ajar" class="form-control @error('tahun_ajar') is-invalid @enderror" name="tahun_ajar" value="{{ old('tahun_ajar') }}" required autocomplete="tahun_ajar" autofocus>
