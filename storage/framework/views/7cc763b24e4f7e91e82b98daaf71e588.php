                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form id="generateBulkForm" method="POST"
                            action="<?php echo e(route('tagihan_bulanan.generateBulkBulanan')); ?>">
                            <?php echo csrf_field(); ?>
                                        ...
                                        <?php if(isset($years) && count($years) > 0): ?>
                                            <?php $__currentLoopData = $years; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $year): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($year); ?>"
                                                    <?php echo e($year == date('Y') ? 'selected' : ''); ?>>
                                                    <?php echo e($year); ?>
                            ...
                            <div id="kelasSelection" style="display:none;" class="mb-4">
                                ...
                                <select name="kelas_id" id="kelas_id" class="form-select">
                                    ...
                                    <?php if(isset($kelasList) && $kelasList->count() > 0): ?>
                            ...
                            <div id="santriSelection" style="display:none;" class="mb-4">
                                ...
                                <div class="santri-selection">
                                    ...
                                    <hr>
                                    <div id="santriList">
                                        <?php if(isset($santris) && $santris->count() > 0): ?>
                                                ...
                                                <div class="form-check santri-item"
                                                    ...
                                                    <label class="form-check-label" for="santri_<?php echo e($santri->id_santri); ?>">
                                                        ...
                                                        <small class="text-muted">
                                                            ...
                                                            <?php echo e($santri->nama_kelas_aktif ?? 'Tanpa Kelas'); ?>)
                                                        </small>
                                                    </label>
                                                </div>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="mb-4">
                                ...
                                <div id="monthSelection">
                                    <?php if(isset($months) && count($months) > 0): ?>
                                        <?php
                                            $monthNames = [
                                                'Jan' => 'Januari',
                                                'Feb' => 'Februari',
                                        ...
                                        <?php $__currentLoopData = $months; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $month => $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <label class="month-checkbox available" data-month="<?php echo e($month); ?>">
                                                <input type="checkbox" name="bulan[]" value="<?php echo e($month); ?>">
                                                <span><?php echo e(substr($monthNames[$month] ?? $month, 0, 3)); ?></span>
                                            </label>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    <?php else: ?>
...
<?php $__env->startSection('script'); ?>
    <script>
        ...
        function generateTagihan() {
            ...
            $.ajax({
                url: "<?php echo e(route('tagihan_bulanan.generateBulkBulanan')); ?>",
                method: 'POST',
                data: formData,
                processData: false,
                contentType: false,
        ...
        function updatePreview() {
            ...
            if (filterType === 'all') {
                targetCount = <?php echo e(isset($santris) ? $santris->count() : 0); ?>;
        ...
        function redirectToIndex() {
            window.location.href = "<?php echo e(route('tagihan_bulanan.index')); ?>";
        }
