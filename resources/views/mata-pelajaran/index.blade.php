...
<div class="row">
    <div class="col-md-2">
        <a href="{{ route('admin.mapel.create') }}" class="btn btn-primary">Tambah Mapel</a><br><br>
    </div>
        ...
        <form action="#" class="flex-sm">
            <div class="input-group">
                ...
                <div class="input-group-append">
                    ...
                    <button onclick="window.location.href='{{ route('admin.mapel.index') }}'" type="button" class="btn btn-md btn-secondary rounded"><i class="fas fa-sync-alt"></i></button>
                </div>
            </div>
        </form>
    </div>
            ...
            <tr>
                ...
                <td align="center">
                    {{-- @if (Auth::mapel()->role == 'Pengurus')
                        ...
                        @else --}}
                    {{-- <a href="{{ route('admin.mapel.edit', $mapel) }}" type="button" class="btn btn-sm btn-info"><i class="fas fa-pen"></i></a> --}}
...
<script>
    ...
    function deleteData(id) {
        let url = '{{ route("admin.mapel.destroy", ":id") }}';
