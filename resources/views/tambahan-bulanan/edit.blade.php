...
@section('content')
    ...
    <form action="{{ route('tambahan_bulanan.update', $item) }}" method="post">
        @csrf
        @method('PUT')
        <div class="container">
            <div class="row">
                <div class="col-sm">
                    <div class="form-group">
                        ...
                        <input id="nama_item" type="text" class="form-control @error('nama_item') is-invalid @enderror"
                ...
                <div class="col-sm">
                    <div class="form-group">
                        ...
                        <input id="nominal" type="number" class="form-control @error('nominal') is-invalid @enderror"
                            name="nominal" value="{{ old('nominal', $item->nominal) }}" required autocomplete="nominal"
                            min=0>
