...
<?php $__env->startSection('content'); ?>
    ...
    <form action="<?php echo e(route('tagihan_terjadwal.store')); ?>" method="post">
        <?php echo csrf_field(); ?>
        <div class="container">
            <div class="row">
                <div class="col-sm">
                    <div class="form-group">
                        ...
                        <select class="form-control select2 <?php $__errorArgs = ['santri_id'];
...
unset($__errorArgs, $__bag); ?>" name="santri_id"
                            required>
...
unset($__errorArgs, $__bag); ?>"
                            id="biaya_terjadwal_id" name="biaya_terjadwal_id" required>
                            ...
                            <?php $__currentLoopData = $biayaTerjadwals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $biaya): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($biaya->id_biaya_terjadwal); ?>" data-periode="<?php echo e($biaya->periode); ?>">
                                    <?php echo e($biaya->nama_biaya); ?>
            ...
            <div class="row">
                <div class="col-sm">
                    <div class="form-group">
                        ...
                        <select class="form-control select2 <?php $__errorArgs = ['tahun'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="tahun" required>
                            <option selected disabled>Pilih Tahun</option>
                            <?php for($i = $now; $i >= 2020; $i--): ?>
...
<?php echo $__env->make('layouts.home', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\SIAKAD_LQ\resources\views/tagihan-terjadwal/create.blade.php ENDPATH**/ ?>