<?php $__env->startSection('title_page', 'Import Pembayaran'); ?>
    ...
    <div class="container">
        <div class="row mb-3">
            ...
            <div class="col-md-4 text-right">
                <a href="<?php echo e(route('pembayaran.bulk.index')); ?>" class="btn btn-secondary">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <a href="<?php echo e(route('pembayaran.bulk.template', ['type' => 'individual'])); ?>"
                            ...
                            <div class="col-md-6">
                                ...
                                <a href="<?php echo e(route('pembayaran.bulk.template', ['type' => 'bulk'])); ?>"
                                    class="btn btn-sm btn-primary">
                                    <i class="fas fa-download"></i> Download Template
                                </a>
                            </div>
...
<?php $__env->startSection('script'); ?>
    <script>
        ...
        function previewImport() {
            ...
            // Send request
            $.ajax({
                url: '<?php echo e(route('pembayaran.bulk.import.preview')); ?>',
                type: 'POST',
                data: formData,
                processData: false,
                contentType: false,
        ...
        function processImport() {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        url: '<?php echo e(route('pembayaran.bulk.import.process')); ?>',
                        type: 'POST',
                        data: {
                        ...
                        success: function(response) {
                            ...
                            if (response.success) {
                                Swal.fire({
                                    ...
                                    window.location.href = '<?php echo e(route('pembayaran.index')); ?>';
                                });
                            } else {
...
<?php echo $__env->make('layouts.home', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\Zidan\Akprind\Sistem-Informasi-Pembayaran-PPLQ\resources\views/pembayaran/import.blade.php ENDPATH**/ ?>