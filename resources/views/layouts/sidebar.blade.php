<div class="main-sidebar sidebar-style-2">
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="dropdown {{ (request()->routeIs('admin.mapel*')|| request()->routeIs('admin.kelas*') || request()->routeIs('admin.mapel_kelas*')) ? 'active' : '' }}">
                <a href="#" class="nav-link has-dropdown" data-toggle="dropdown"><i class="fas fa-file-invoice"></i> <span>Kurikulum</span></a>
                <ul class="dropdown-menu">
