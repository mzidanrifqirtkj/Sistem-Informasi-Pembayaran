...
@section('content')
    ...
    <div class="row">
        <div class="col-md-2">
            <a href="{{ route('kelas.create') }}" class="btn btn-primary">Tambah Kelas</a><br><br>
        </div>
            ...
            <form action="#" class="flex-sm">
                <div class="input-group">
                    ...
                    <div class="input-group-append">
                        ...
                        <button onclick="window.location.href='{{ route('kelas.index') }}'" type="button"
            ...
            <tbody>
                @forelse ($kelas as $kls)
                    <tr>
                        ...
                        @else --}}
                            <a href="{{ route('kelas.edit', $kls) }}" type="button" class="btn btn-sm btn-info"><i
                                    class="fas fa-pen"></i></a>
                            <a href="javascript:void(0)" id="btn-delete" class="btn btn-sm btn-danger"
                                onclick="deleteData('{{ $kls->id_kelas }}')" data-toggle="modal"
...
@section('script')
    <script>
        function deleteData(id) {
            let url = '{{ route('kelas.destroy', ':id') }}';
